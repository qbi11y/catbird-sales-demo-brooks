...
Catbird.Insight.TopologyGraph = Ext.extend(Catbird.Charts.D3Chart, {
    animationTime: 750,
    ...
    initComponent: function() {
        ...
        this.subComponents = [
            this.Ring = Catbird.Insight.TopologyGraph.RingCls(this),
            this.Selection = Catbird.Insight.TopologyGraph.SelectionCls(this),
            this.Endpoint = Catbird.Insight.TopologyGraph.EndpointCls(this),
            this.Flow = Catbird.Insight.TopologyGraph.FlowCls(this),
            this.Legend = Catbird.Insight.TopologyGraph.LegendCls(this)
        ];
...
Ext.reg('cb.insight.topologygraph', Catbird.Insight.TopologyGraph);
